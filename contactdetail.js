  ...
  try {
    ...
    for (const companyName of companyNames) {
      ...
      if (firstResult) {
        ...
        companyData.push({ company: companyName, title, link, companyLink: '', ceoName: '' });

        console.log('Title:', title);
        console.log('Link:', link);
      } else {
        console.log(`No matching result found for ${companyName}.`);
        companyData.push({ company: companyName, title: 'Not Found', link: 'Not Found', companyLink: '' , ceoName : ''});
      }
    }
    ...
    if (ceoName) {
      ...
      console.log('linkedinUrl:',  ceoName);
      }

    } else {
      console.log(`No matching result found for  ${ceoName}`);
    }
  }
